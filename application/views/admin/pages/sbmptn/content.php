...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Data Siswa SBMPTN</li>
    </ol>
  </section>
        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="col-md-12 table-responsive">
              <table id="tableSBMPTN" class="table table-striped table-hover">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Nama Lengkap</th>
