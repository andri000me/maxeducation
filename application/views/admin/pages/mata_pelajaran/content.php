...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Data Siswa Music</li>
    </ol>
  </section>
              ...
              <div class="col-md-12">
                <div class="nav-tabs-custom">
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab_1" data-toggle="tab">Kelas IX A</a></li>
                    <li><a href="#tab_2" data-toggle="tab">Kelas IX B</a></li>
                    <li><a href="#tab_3" data-toggle="tab">Kelas IX C</a></li>
                  </ul>

                  <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                      <button class="btn btn-flat btn-default" onclick="reload_table_Siswa_Kelas_IXA()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>
                      <br>
                      <div class="col-md-12 table-responsive">
                        <br>
                        <table id="siswaKelasIXATable" class="table table-bordered table-striped table-hover">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>NIN</th>
                    ...
                    <div class="tab-pane" id="tab_2">
                      <button class="btn btn-flat btn-default" onclick="reload_table_Siswa_Kelas_IXB()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>
                      <div class="col-md-12 table-responsive">
                        <br>
                        <table id="siswaKelasIXBTable" class="table table-bordered table-striped table-hover">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>NIN</th>
                    ...
                    <div class="tab-pane" id="tab_3">
                      <button class="btn btn-flat btn-default" onclick="reload_table_Siswa_Kelas_IXC()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>
                      <div class="col-md-12 table-responsive">
                        <br>
                        <table id="siswaKelasIXCTable" class="table table-bordered table-striped table-hover">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>NIN</th>
