			...
			<?php foreach ($kelas_posts as $post): ?>
				...
				<div class="box box-info">
					<div class="box-header with-border">
						<div class="user-block">
							<span class="username"><strong><?= $post->username ?>
								...
								<?php endif ?>
							</strong> untuk <a href="<?= site_url('guru/kelas/'.$post->slug) ?>"><?= $post->nama_kelas ?></a></span>
					...
					<div class="box-footer clearfix">
						...
						<!-- <span class="pull-right text-muted"><?= $kelas_comments  ?> Komentar</span> -->
					</div>
...
<script>
	const URL_TAMBAH_POST = `<?= site_url()?>guru/post/create`;
	const URL_DELETE_POST = `<?= site_url() ?>guru/post/delete/`;
