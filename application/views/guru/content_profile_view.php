      ...
      <div class="col-md-3">
        ...
        <div class="box box-primary">
          <div class="box-body box-profile">
            ...
            <h3 class="profile-username text-center"><?= $user->nama_lengkap_guru ?></h3>
            ...
            <div class="active tab-pane" id="settings">
              <form class="form-horizontal" method="POST" id="formUpdateInformasi" action="javascript:void(0)">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputName" name="nama_lengkap_guru" value="<?= isset($user) ? $user->nama_lengkap_guru : '' ?>">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a href="<?= site_url()?>guru" class="btn btn-flat btn-danger btn-danger">Batal</a>
                  </div>
                </div>
              </form>
            </div>
...
<script>
  const URL_UPDATE_PASSWORD = `<?= site_url('guru/profile/password/update/')?>`;
  const URL_UPDATE_INFORMASI = `<?= site_url('guru/profile/informasi/update/')?>`;
  ...
  function saveInformasiUserEdit() {
    ...
    let id_guru = `<?= $this->session->userdata('guru_id') ?>`;

    var formData = new FormData($('#formUpdateInformasi')[0]);
    $.ajax({
      url : `${URL_UPDATE_INFORMASI}${id_guru}`,
      type: "POST",
      data: formData,
      contentType: false,
      processData: false,
