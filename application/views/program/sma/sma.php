<section class="header11 cid-qIoZib7Tzp mbr-fullscreen" id="header11-n">

    <div class="container align-left">
        <div class="media-container-column mbr-white col-md-12">
            <h3 class="mbr-section-subtitle py-3 mbr-fonts-style display-5"><br><br>SMA</h3>
            ...
            <p class="mbr-text py-3 mbr-fonts-style display-5">Saat pelajaran makin sulit, <strong>Max Education</strong> membuat segalanya jadi mudah. Ijinkan kami membantu Anak Anda mencapai kemaksimalan prestasi di sekolahnya.&nbsp;</p>
    ...
    <section class="cid-qIWBZkjWKQ" id="pricing-tables1-1i" style="background-image: url(<?= base_url() ?>assets/images/mbr-1631x1080.jpg);">
            ...
            <div class="media-container-row">
                ...
                <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                    <div class="plan-header text-center pt-5">
                        ...
                        <div class="plan-price">
                            ...
                            <span class="price-figure mbr-fonts-style display-5">1.200.000</span>
                    ...
                    <div class="plan-body pb-5">
                        <div class="plan-list align-center">
                            <ul class="list-group list-group-flush mbr-fonts-style display-7">
                                ...
                                </li><li class="list-group-item">Bahasa Inggris</li>
                                <li class="list-group-item">
                ...
                <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                    <div class="plan-header text-center pt-5">
                        ...
                        <div class="plan-price">
                            ...
                            <span class="price-figure mbr-fonts-style display-5">1.600.000</span>
                            <small class="price-term mbr-fonts-style display-7">
                            per bulan</small>
                        </div>
                    </div>
                    <div class="plan-body pb-5">
                        <div class="plan-list align-center">
                            <ul class="list-group list-group-flush mbr-fonts-style display-7">
                                ...
                                </li><li class="list-group-item">Bahasa Inggris</li><li class="list-group-item">Waktu Belajar 2 Jam</li>
                            </ul>
                        </div>
                ...
                <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                    <div class="plan-header text-center pt-5">
                        ...
                        <div class="plan-price">
                            <span class="price-value mbr-fonts-style display-7">Rp. &nbsp;</span>
                            <span class="price-figure mbr-fonts-style display-5">2.400.000</span>
                            <small class="price-term mbr-fonts-style display-7">
                            per bulan</small>
                        </div>
                    </div>
