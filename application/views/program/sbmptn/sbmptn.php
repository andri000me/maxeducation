<section class="header11 cid-qIoZib7Tzp mbr-fullscreen" id="header11-r">

    <div class="container align-left">
        <div class="media-container-column mbr-white col-md-12">
            <h3 class="mbr-section-subtitle py-3 mbr-fonts-style display-5">SBMPTN</h3>
            ...
            <p class="mbr-text py-3 mbr-fonts-style display-5">Kuliah di Universitas Negeri unggulan merupakan mimpi banyak orang. Dengan Guru-guru yang profesional,  <strong>MAX Education</strong> siap membantu persiapan Anak Anda dengan fokus dan tajam. Mari wujudkan mimpi kuliah di Universitas Negeri unggulan!&nbsp;</p>
...
<section class="cid-qIWuRc8079" id="pricing-tables1-1g" style="background-image: url(<?= base_url() ?>assets/images/mbr-2-1620x1080.jpg);">
        ...
        <div class="media-container-row">
            ...
            <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                <div class="plan-header text-center pt-5">
                    <h3 class="plan-title mbr-fonts-style display-5">Private 1 Orang</h3>
                    <div class="plan-price">
                        <span class="price-value mbr-fonts-style display-7">Rp.&nbsp;</span>
                        <span class="price-figure mbr-fonts-style display-5">2.000.000</span>
                ...
                <div class="plan-body pb-5">
                    <div class="plan-list align-center">
                        <ul class="list-group list-group-flush mbr-fonts-style display-7">
                            <li class="list-group-item">Matematika
                            </li><li class="list-group-item">Fisika</li><li class="list-group-item">Kimia</li><li class="list-group-item">Bahasa Inggris
                            </li><li class="list-group-item">Ekonomi
                            </li><li class="list-group-item">Sosiologi
                            </li><li class="list-group-item">Geografi</li>
                            <li class="list-group-item">Waktu Belajar 2 Jam</li>
                        </ul>
                    </div>
                    <div class="mbr-section-btn text-center pt-4"><a id="btnOnRegisterPrivate1" class="btn btn-primary display-4"><span class="mbri-edit mbr-iconfont mbr-iconfont-btn"></span>DAFTAR</a></div>
                </div>
            </div>
            ...
            <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                <div class="plan-header text-center pt-5">
                    ...
                    <div class="plan-price">
                        <span class="price-value mbr-fonts-style display-7">Rp.&nbsp;</span>
                        <span class="price-figure mbr-fonts-style display-5">3.000.000</span>
                        <small class="price-term mbr-fonts-style display-7">
                        per bulan</small>
                    </div>
                </div>
                <div class="plan-body pb-5">
                    <div class="plan-list align-center">
                        <ul class="list-group list-group-flush mbr-fonts-style display-7">
                            <li class="list-group-item">Matematika
                            </li><li class="list-group-item">Fisika
                            </li><li class="list-group-item">Kimia
                            </li><li class="list-group-item">Bahasa Inggris
                            </li><li class="list-group-item">Ekonomi
                            </li><li class="list-group-item">Sosiologi
                            </li><li class="list-group-item">Geografi
                            </li><li class="list-group-item">Waktu Belajar 2 Jam</li>
                        </ul>
                    </div>
                    <div class="mbr-section-btn text-center pt-4"><a id="btnOnRegisterPrivate2" class="btn btn-primary display-4"><span class="mbri-edit mbr-iconfont mbr-iconfont-btn"></span>DAFTAR</a></div>
                </div>
            </div>
            ...
            <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                <div class="plan-header text-center pt-5">
                    ...
                    <div class="plan-price">
                        <span class="price-value mbr-fonts-style display-7">Rp.&nbsp;</span>
                        <span class="price-figure mbr-fonts-style display-5">3.750.000</span>
                        <small class="price-term mbr-fonts-style display-7">
                        per bulan</small>
                    </div>
                </div>
                <div class="plan-body pb-5">
                    ...
                    <div class="mbr-section-btn text-center pt-4"><a id="btnOnRegisterGroup3" class="btn btn-primary display-4"><span class="mbri-edit mbr-iconfont mbr-iconfont-btn"></span>DAFTAR</a></div>
                </div>
            </div>

            <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                <div class="plan-header text-center pt-5">
                    <h3 class="plan-title mbr-fonts-style display-5">Group 4 Orang</h3>
                    <div class="plan-price">
                        <span class="price-value mbr-fonts-style display-7">Rp.&nbsp;</span>
                        <span class="price-figure mbr-fonts-style display-5">4.600.000</span>
                        <small class="price-term mbr-fonts-style display-7">
                        per bulan</small>
                    </div>
                </div>
                <div class="plan-body pb-5">
                    ...
                    <div class="mbr-section-btn text-center pt-4"><a id="btnOnRegisterGroup4" class="btn btn-primary display-4"><span class="mbri-edit mbr-iconfont mbr-iconfont-btn"></span>DAFTAR</a></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  method="POST" action="javascript:void(0);" id="form_Register">
                        ...
                        <input type="hidden" name="id_program" value="4">
...
<script>
    $(document).ready(function() {
        ...
        $('#btnOnRegisterPrivate2').click(function() {
            $('#form_Register')[0].reset(); 
            $('#modal_Register').modal({backdrop: 'static', keyboard: false, show: true});
        });

        $('#btnOnRegisterGroup3').click(function() {
            $('#form_Register')[0].reset(); 
            $('#modal_Register').modal({backdrop: 'static', keyboard: false, show: true});
        });
        $('#btnOnRegisterGroup4').click(function() {
            $('#form_Register')[0].reset(); 
            $('#modal_Register').modal({backdrop: 'static', keyboard: false, show: true});
        });
    });
