<section class="header11 cid-qIoZib7Tzp mbr-fullscreen" id="header11-v">
    <div class="container align-left">
        <div class="media-container-column mbr-white col-md-12">
            <h3 class="mbr-section-subtitle py-3 mbr-fonts-style display-5"><br><br>ENGLISH CONVERSATION</h3>
            <h1 class="mbr-section-title py-3 mbr-fonts-style display-1">It's no matter to learn English with&nbsp;<strong>MAX Education</strong>.<br>
            </h1>
            <p class="mbr-text py-3 mbr-fonts-style display-5">English has become widespread in every country. Learning English could bring us to fly around the world and one steap ahead for a better future. With our fun and profesional teachers, we will take you to a next level in learning English. Lets speak Englsih more!&nbsp;</p>
...
<section class="cid-qIWE49hfZZ" id="pricing-tables1-1j" style="background-image: url(<?= base_url() ?>assets/images/mbr-1623x1080.jpg);">
        ...
        <div class="media-container-row">
                    ...
                    <div class="plan-list align-center">
                        <ul class="list-group list-group-flush mbr-fonts-style display-7">
                            <li class="list-group-item">
                                Conversation
                            </li><li class="list-group-item">Reading</li><li class="list-group-item">Writing</li>
                            <li class="list-group-item">
                            Waktu Belajar 2 jam</li>
                        </ul>
                    </div>
                    <div class="mbr-section-btn text-center pt-4"><a id="btnOnRegisterSchool" class="btn btn-primary display-4"><span class="mbri-edit mbr-iconfont mbr-iconfont-btn"></span>DAFTAR</a></div>
                </div>
            </div>
                ...
                <div class="plan-body pb-5">
                    <div class="plan-list align-center">
                        <ul class="list-group list-group-flush mbr-fonts-style display-7">
                            <li class="list-group-item">
                                Conversation
                            </li><li class="list-group-item">Reading
                            </li><li class="list-group-item">Writing</li>
                            <li class="list-group-item">Waktu Belajar 2 jam</li>
                        </ul>
                    </div>
                    <div class="mbr-section-btn text-center pt-4"><a id="btnOnRegisterSbmptn" class="btn btn-primary display-4"><span class="mbri-edit mbr-iconfont mbr-iconfont-btn"></span>DAFTAR</a></div>
                </div>
            </div>
            ...
            <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-4">
                ...
                <div class="plan-body pb-5">
                    ...
                    <div class="mbr-section-btn text-center pt-4"><a id="btnOnRegisterConversation" class="btn btn-primary display-4">DAFTAR</a></div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $('#btnOnRegisterSchool').click(function() {
            $('#form_Register')[0].reset(); 
            $('#modal_Register').modal({backdrop: 'static', keyboard: false, show: true});
        });

        $('#btnOnRegisterSbmptn').click(function() {
            $('#form_Register')[0].reset(); 
            $('#modal_Register').modal({backdrop: 'static', keyboard: false, show: true});
        });

        $('#btnOnRegisterConversation').click(function() {
            $('#form_Register')[0].reset(); 
            $('#modal_Register').modal({backdrop: 'static', keyboard: false, show: true});
        });
