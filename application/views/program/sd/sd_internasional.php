<section class="header11 cid-qIoZib7Tzp mbr-fullscreen" id="header11-f">

    <div class="container align-left">
        <div class="media-container-column mbr-white col-md-12">
            <h3 class="mbr-section-subtitle py-3 mbr-fonts-style display-5"><br><br><br>ELEMENTARY SCHOOL</h3>
            <h1 class="mbr-section-title py-3 mbr-fonts-style display-1">Private Course is more fun with&nbsp;<strong>MAX Education</strong>.<br>
            </h1>
            <p class="mbr-text py-3 mbr-fonts-style display-5">The stereotype of private course is boring is perfectly gone here. Because in <strong>MAX Education</strong>, private course becomes happier and easier to understood. Besides the flexible time and place , the teachers are professional and easygoing.&nbsp;<br></p>
...
<section class="cid-qIWsdgYCVY" id="pricing-tables1-1f" style="background-image: url(<?= base_url() ?>assets/images/mbr-1610x1080.jpg);">
            ...
            <div class="plan col-12 mx-2 my-2 justify-content-center">
                <div class="plan-header text-center pt-5">
                    ...
                    <div class="plan-price">
                        ...
                        <span class="price-figure mbr-fonts-style display-5">960.000</span>
                ...
                <div class="plan-body pb-5">
                    <div class="plan-list align-center">
                        <ul class="list-group list-group-flush mbr-fonts-style display-7">
                            ...
                            Include all subjects</li>
                            <li class="list-group-item">Up to Two Hours Studying</li>
                        </ul>
                    </div>
                    <div class="mbr-section-btn text-center pt-4"><a id="btnOnRegisterPrivate" class="btn btn-primary display-4"><span class="mbri-edit mbr-iconfont mbr-iconfont-btn"></span>DAFTAR</a></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        $('#btnOnRegisterPrivate').click(function() {
