                ...
                <div class="plan col-12 mx-2 my-2 justify-content-center">
                    <div class="plan-header text-center pt-5">
                        ...
                        <div class="plan-price">
                            ...
                            <span class="price-figure mbr-fonts-style display-5">800.000</span>
                        ...
                        <div class="plan-list align-center">
                            <ul class="list-group list-group-flush mbr-fonts-style display-7">
                                <li class="list-group-item">
                                    Guitar
                                </li><li class="list-group-item">Piano
                                </li><li class="list-group-item">Keyboard
                                </li><li class="list-group-item">Drumb
                                </li><li class="list-group-item">Violin</li>
                                <li class="list-group-item">
