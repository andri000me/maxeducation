...
<section class="content-header">
	...
	<ol class="breadcrumb">
		<li><a href="<?= site_url()?>siswa"><i class="fa fa-dashboard"></i> Home</a></li>
...
<section class="content">
			...
			<div class="box box-info">
				<div class="box-header with-border">
					...
					<div class="user-block">
						...
						</strong> untuk <a href="<?= site_url('siswa/kelas/'.$kiriman->slug) ?>"><?= $kiriman->nama_kelas ?></a></span>
						...
						<?php if ($this->session->userdata('user_id') == $kiriman->user_id): ?>
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a href="<?= site_url('siswa/post/edit/'.$kiriman->id_kelas_posts)?>">Ubah Kiriman</a>
									</li>
								</ul>
							</div>
						<?php endif ?>
					...
					<div class="col-xs-12 col-md-12">
						...
						<?php if (!empty($kiriman->document)): ?>
							<div class="attachment-block clearfix">
								<a href="<?= site_url('siswa/post/download/'. $kiriman->id_kelas_posts); ?>"><?= $kiriman->document?></a>
							</div>
						<?php endif ?>
						...
						<div class="box-comment" style="margin-bottom: 2px">
							<div class="comment-text">
								...
								<?php if (!empty($comment->document)): ?>
									<div class="attachment-block clearfix">
										<a href="<?= site_url('siswa/post/download/'. $comment->id_kelas_comments); ?>"><?= $comment->document?></a>
									</div>
								<?php endif ?>
				...
				<div class="box-footer">
					...
					<button class="btn btn-primary pull-right" id="btnSaveComment" onclick="comment()">Kirim</button>
				</div>
	...
	<div class="row">
		<div class="col-lg-9">
			<div class="box">
				<div class="box-body">
					<button class="btn btn-danger btn-block" onclick="window.history.go(-1)" type="reset">Kembali</button>
				</div>
			</div>
