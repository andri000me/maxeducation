...
class Sma extends CI_Controller {
	...
	public function index()
	{
		$data = [
			...
			'content' => $this->load->view('admin/pages/sma/content', NULL, TRUE),
	...
	public function get_siswa_sma(){
		$list = $this->Siswa_model->get_datatables_sma();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
			...
			"recordsFiltered" => $this->Siswa_model->count_filtered_sma(),
			"data" => $data,
		);
