...
class Sd extends CI_Controller {
	...
	{
		$data = [
			'title' => 'MAX Education | Admin - Data Siswa SD',
			'content' => $this->load->view('admin/pages/sd/content', NULL, TRUE),
	...
	public function get_siswa_sd(){
		$list = $this->Siswa_model->get_datatables_sd();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
			...
			"recordsFiltered" => $this->Siswa_model->count_filtered_sd(),
			"data" => $data,
		);
