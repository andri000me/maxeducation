...
class Sbmptn extends CI_Controller {
	...
	public function index()
	{
		$data = [
			...
			'content' => $this->load->view('admin/pages/sbmptn/content', NULL, TRUE),
	...
	public function get_siswa_sbmptn(){
		$list = $this->Siswa_model->get_datatables_sbmptn();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
			...
			"recordsFiltered" => $this->Siswa_model->count_filtered_sbmptn(),
			"data" => $data,
		);
