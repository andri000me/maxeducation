...
class Inggris extends CI_Controller {
	...
	{
		$data = [
			'title' => 'MAX Education | Admin - Data Siswa Inggris',
			'content' => $this->load->view('admin/pages/inggris/content', NULL, TRUE),
	...
	public function get_siswa_inggris(){
		$list = $this->Siswa_model->get_datatables_inggris();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
			...
			"recordsFiltered" => $this->Siswa_model->count_filtered_inggris(),
			"data" => $data,
		);
