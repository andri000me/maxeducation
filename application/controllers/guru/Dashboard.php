...
class Dashboard extends CI_Controller {
	...
	// private $hari = $this->format_waktu->format_hari(date('l'));

	public function index()
	{
		$data = [
			'title' => 'MAX Education | Halaman Guru',
			'content' => $this->load->view('guru/content_guru_view', [
				'kelas' => $this->Kelas_model->get_kelas_guru($this->session->userdata('guru_id')),
				'kelas_posts' => $this->Kelas_post_model->get_kelas_posts($this->session->userdata('guru_id')),
			], TRUE),
	...
	public function view_post($id_kelas_posts)
	{
		...
		$data = [
			...
			'content' => $this->load->view('guru/content_post_view', [
				'kiriman' => $post,
	...
	public function edit_post($id_kelas_posts)
	{
		$data = [
			'title' => 'MAX Education | Halaman Kiriman',
			'content' => $this->load->view('guru/content_edit_post_view', [
				'kelass' => $this->Kelas_model->get_kelas_guru($this->session->userdata('guru_id')),
				'kiriman' => $this->Kelas_post_model->get_post_by_id($id_kelas_posts),
